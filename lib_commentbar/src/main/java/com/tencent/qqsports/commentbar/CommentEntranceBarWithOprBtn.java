...
public class CommentEntranceBarWithOprBtn extends CommentEntranceBar implements View.OnClickListener, CommonSupportView.ICommonSupportViewListener {
    ...
    private void initSubclassSpecialView() {
        ...
        if (mCommentBtnContainer != null) {
            mCommentBtnContainer.setVisibility(mIncludeCommentBtn ? View.VISIBLE : View.GONE);
        }
        if (mShareBtnIcon != null) {
            mShareBtnIcon.setVisibility(mIncludeShareBtn ? View.VISIBLE : View.GONE);
        }
        if (mSupportView != null) {
            mSupportView.setVisibility(mIncludeSupportBtn ? View.VISIBLE : View.GONE);
    ...
    public void setShareBtnVisibility(boolean visible) {
        ...
        if (mShareBtnIcon != null) {
            mShareBtnIcon.setVisibility(visible && mIncludeShareBtn ? View.VISIBLE : View.GONE);
        }
    }
    ...
    public void setSupportBtnVisibility(boolean visible) {
        ...
        if (mSupportView != null) {
            mSupportView.setVisibility(visible && mIncludeSupportBtn ? View.VISIBLE : View.GONE);
        }
    }
